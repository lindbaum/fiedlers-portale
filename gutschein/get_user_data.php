        ...
        <table class="tbl_1">
            <tbody>
                ...
                <tr>
					...
					// Zeitspanne setzen ---> Oktober 2013
					// bis 12:00 buchbar am folgenden Werktag, sonst ab darauffolgenden Werktag!
					/*
					if (date('H',time()) < 12) {
						switch(date('N',time())) {
							case 1: $addDay = 24; break;
							case 2: $addDay = 24; break;
							case 3: $addDay = 24; break;
							case 4: $addDay = 96; break;
							case 5: $addDay = 96; break;
							case 6: $addDay = 72; break;
							case 7: $addDay = 48; break;
						}
					} else {
						switch(date('N',time())) {
							case 1: $addDay = 48; break;
							case 2: $addDay = 48; break;
							case 3: $addDay = 120; break;
							case 4: $addDay = 96; break;
							case 5: $addDay = 96; break;
							case 6: $addDay = 72; break;
							case 7: $addDay = 48; break;
					...
					$start_datum = mktime(0,0,0,date('m'),date('d'),date('Y')) + (60 * 60 * $addDay);
					*/
					
					// Zeitspanne setzen ---> Dezember 2013
					// bis 6:00 buchbar am gleichen Tag, dann ab Folgetag!
					(date('H',time()) < 6) ? $start_datum = mktime(0,0,0,date('m'),date('d'),date('Y')) : $start_datum = mktime(0,0,0,date('m'),date('d'),date('Y')) + (60 * 60 * 24);
