...
if(isset($_POST['multiedit'])) {
    ...
    if(!isset($_POST['multi_check_rechnungsnummer']) && !isset($_POST['multi_check_berechnung'])) $error = 'Zum Speichern bitte mindestens ein Feld anw&auml;hlen.';
    
    elseif(isset($_POST['multi_check_rechnungsnummer']) && isset($_POST['multi_check_berechnung']) && $_POST['multi_check_rechnungsnummer'] == 'on' && $_POST['multi_check_berechnung'] == 'on') {
        
        (isset($_POST['multi_rechnungsnummer']) && trim($_POST['multi_rechnungsnummer']) != '') ? $multi_rechnungsnummer = trim(htmlspecialchars($_POST['multi_rechnungsnummer'])) : $error .= '<br />Bitte eine Rechnungsnummer angeben.';
        $multi_berechnungsart = $_POST['multi_berechnungsart'];
        $multi_ids = substr($_POST['multi_ids'], 0, -1);
        
        if(empty($error)) { // Daten sind korrekt und kšnnen gespeichert werden...
            
            $sql = "UPDATE gsv_gutschein
                    SET gsv_berechnungsart_bere_id=?, rechnungs_nummer=?
                    WHERE gutschein_nummer IN ($multi_ids)";
            
            //print $sql;
            
            $kommando = $db->prepare($sql);
            $kommando->bind_param('is', $multi_berechnungsart, $multi_rechnungsnummer);
            $kommando->execute();
    ...
    elseif(isset($_POST['multi_check_rechnungsnummer']) && !isset($_POST['multi_check_berechnung']) && $_POST['multi_check_rechnungsnummer'] == 'on') {
    ...
    elseif(isset($_POST['multi_check_berechnung']) && !isset($_POST['multi_check_rechnungsnummer']) && $_POST['multi_check_berechnung'] == 'on') {
        ...
        if(empty($error)) { // Daten sind korrekt und kšnnen gespeichert werden...
            ...
            $sql = "UPDATE gsv_gutschein
                    SET gsv_berechnungsart_bere_id=?
                    WHERE gutschein_nummer IN ($multi_ids)";
                ...
                */
                ...
                while($kommando->fetch()) {
                    ...
                    */
                    ...
                    printf('<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>',
                           $gutscheinnummer, $ausgabedatum, $praesent, $kundenname, $enddatum, $rechnungsnummer, $berechnung, $einloesungsort,
                           $einloesedatum, $str_ist_abgelaufen, $str_ist_eingeloest, '<a href="coupons_edit.php?edit=' . $gutscheinnummer . '&redeem=' . $ist_eingeloest . '">Edit</a>');
                ...
                <div class="contentBox">
                    <form name="update" id="update" method="post">
                        <table width="400" border="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="multi_check_berechnung" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                        ...
                        <input type="hidden" name="check_gutscheinnummer" value="<?php print $_POST['check_gutscheinnummer']; ?>" />
                        ...
                        <input type="hidden" name="check_rechnungsnummer" value="<?php print $_POST['check_rechnungsnummer']; ?>" />
                        <input type="hidden" name="srch_rgnummer_text" value="<?php print htmlspecialchars($_POST['srch_rgnummer_text']); ?>" />
                        <input type="hidden" name="check_rechnungsnummer_text" value="<?php print $_POST['check_rechnungsnummer_text']; ?>" />
                        ...
                        <input type="hidden" name="check_ausgabedatum" value="<?php print $_POST['check_ausgabedatum']; ?>" />
                        ...
                        <input type="hidden" name="check_einloesedatum" value="<?php print $_POST['check_einloesedatum']; ?>" />
                        ...
                        <input type="hidden" name="check_befristung" value="<?php print $_POST['check_befristung']; ?>" />
                        <input type="hidden" name="praesent" value="<?php print $_POST['praesent']; ?>" />
                        <input type="hidden" name="check_praesent" value="<?php print $_POST['check_praesent']; ?>" />
                        <input type="hidden" name="verschenker" value="<?php print $_POST['verschenker']; ?>" />
                        <input type="hidden" name="check_verschenker" value="<?php print $_POST['check_verschenker']; ?>" />
                        <input type="hidden" name="berechnungsart" value="<?php print $_POST['berechnungsart']; ?>" />
                        <input type="hidden" name="check_berechnungsart" value="<?php print $_POST['check_berechnungsart']; ?>" />
                        <input type="hidden" name="einloesungsort" value="<?php print $_POST['einloesungsort']; ?>" />
                        <input type="hidden" name="check_einloesungsort" value="<?php print $_POST['check_einloesungsort']; ?>" />
                        <input type="hidden" name="srch_abgelaufen" value="<?php print $srch_abgelaufen; ?>" />
                        <input type="hidden" name="check_abgelaufen" value="<?php print $_POST['check_abgelaufen']; ?>" />
                        <input type="hidden" name="srch_eingeloest" value="<?php print $srch_eingeloest; ?>" />
                        <input type="hidden" name="check_eingeloest" value="<?php print $_POST['check_eingeloest']; ?>" />
                        <input type="hidden" name="srch_empf_name" value="<?php print $_POST['srch_empf_name']; ?>" />
                        <input type="hidden" name="check_empf_name" value="<?php print $_POST['check_empf_name']; ?>" />
                        <input type="hidden" name="srch_empf_ort" value="<?php print $_POST['srch_empf_ort']; ?>" />
                        <input type="hidden" name="check_empf_ort" value="<?php print $_POST['check_empf_ort']; ?>" />
                        <input type="hidden" name="srch_empf_land" value="<?php print $_POST['srch_empf_land']; ?>" />
                        <input type="hidden" name="check_empf_land" value="<?php print $_POST['check_empf_land']; ?>" />
