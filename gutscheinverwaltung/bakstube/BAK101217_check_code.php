...
if(isset($_POST['submit'])) {
    $error = '';
    (isset($_POST['nummer']) && preg_match('/^([0-9]{5})$/', $_POST['nummer'])) ? $nummer = $_POST['nummer'] : $error .= '<br />Bitte geben Sie eine korrekte Gutscheinnummer ein.';
    (isset($_POST['code']) && preg_match('/^([A-Z0-9]{12})$/', $_POST['code'])) ? $code = $_POST['code'] : $error .= '<br />Bitte geben Sie einen korrekten Code ein.';
    
    if(empty($error)) {
        // Gutschein auf GŸltigkeit prŸfen
                    ...
                    <table width="500" border="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input class="text_field" type="number" name="nummer" min="5" max="5" step="1" placeholder="Gutscheinnummer" required="required" /></td>
                            </tr>
                            <tr>
