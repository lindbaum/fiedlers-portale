    ...
    <div id="main">
        ...
        <div id="content">
            ...
            if(isset($_POST['date1']) && $_POST['date1'] != '0000-00-00') {
                ...
                $tbl_header = array('Anrede', 'Vorname', 'Name', 'Firma', 'Strasse', 'Haus-Nr.', 'PLZ', 'Ort', 'Email', 'GS-Nr.', 'Pr&auml;sent', 'Gewicht', 'Vers.-Datum');
                ...
                while($kommando->fetch()) {
                    printf('<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>',
                           $anrede, $vorname, $nachname, $firma, $strasse, $hnr, $plz, $ort, $email, $gsnummer, $praesent, $gewicht, date('d.m.Y', $versanddatum));
                }
                ...
                <tfoot>
                    <tr>
                        <td colspan="13"><?php printf('%s Eintr&auml;ge gefunden.', $kommando->num_rows); ?></td>
                    </tr>
                </tfoot>
