...
// Paramterübergabe
if (isset($_GET['edit']) && preg_match('/^[0-9]{5,6}$/', $_GET['edit'])) {
    $edit = $_GET['edit'];
}
if (isset($_GET['redeem']) && preg_match('/^[0-9]{1}$/', $_GET['redeem'])) {
    $redeem = $_GET['redeem'];
}

$heute_time = mktime(0, 0, 0, date('m'), date('d'), date('Y'));
$heute = date('Y-m-d', $heute_time);
...
if (isset($_POST['submit'])) {
    ...
    $verschenker = isset($_POST['verschenker']) ? $_POST['verschenker'] : '';
    $berechnung = isset($_POST['berechnung']) ? $_POST['berechnung'] : '';
    ...
    if (empty($error)) {
        ...
        if (isset($redeem) && $redeem == 0) {
            ...
            if ($kommando->affected_rows == 1) {
                $success = '<img src="images/tick.png" align="top" />&nbsp;Datensatz wurde erfolgreich gespeichert.';
            }
            if ($kommando->error) {
                $error = '<img src="images/cross.png" align="top" />&nbsp;Beim Speichern der Daten ist ein Fehler aufgetreten!';
            }

            // Stati des Gutscheins aktualisieren
            if ($befristung < $heute_time && !empty($befristung)) {
                // Nun abgelaufenen Gutschein deaktivieren
                $sql = "UPDATE gsv_gutschein SET ist_abgelaufen=1, gsv_einloesungsort_einl_id=5 WHERE ist_eingeloest=0 AND gutschein_nummer=?";
            ...
            if ($befristung >= $heute_time || empty($befristung)) {
                // Abgelaufenen Gutschein, dessen Befristung leer ist oder in der Zukunft liegt, wieder aktivieren
                $sql = "UPDATE gsv_gutschein SET ist_abgelaufen=0, gsv_einloesungsort_einl_id=1 WHERE ist_eingeloest=0 AND gutschein_nummer=?";
            ...
            $kommando = $db->prepare($sql);
            $kommando->bind_param('ssiiissssssssssssii', $befristung, $rechnungsnummer, $berechnung, $praesent,
                $verschenker, $anrede, $name, $vorname,
        ...
        <div id="main">
            ...
            <div id="content">
                ...
                if (isset($kommando) && $kommando->num_rows == 1) {
                    ...
                    <div class="contentBox">
                        ...
                        <form method="post" autocomplete="off">
                            ...
                            <table width="400" border="0">
                                <thead>
                                <tr>
                                    <th colspan="2">Gutschein Details
                                    </td>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    ...
                                    <td><input class="text_field" type="text" name="gutscheinnummer"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if (!empty($befristung)) {
                                            $myCalendar->setDate(date("d", $befristung), date("m", $befristung),
                                                date("Y", $befristung));
                                        }
                                    ...
                                    <td>
                                        <select class="select_field" name="verschenker">
                                            ...
                                            while ($kommando->fetch()) {
                                                ($wert1 == $verschenker) ? printf('<option value="%s" selected>%s</option>',
                                                    $wert1, $wert2) : printf('<option value="%s">%s</option>', $wert1,
                                                    $wert2);
                                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="select_field" name="praesent">
                                            ...
                                            while ($kommando->fetch()) {
                                                ($wert1 == $praesent) ? printf('<option value="%s" selected>%s</option>',
                                                    $wert1, $wert2) : printf('<option value="%s">%s</option>', $wert1,
                                                    $wert2);
                                            }
                                ...
                                <tr>
                                    ...
                                    <td><input class="text_field" type="text" name="rechnungsnummer"
                                               value="<?php if (isset($rechnungsnummer)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="select_field" name="berechnung">
                                            ...
                                            while ($kommando->fetch()) {
                                                ($wert1 == $berechnung) ? printf('<option value="%s" selected>%s</option>',
                                                    $wert1, $wert2) : printf('<option value="%s">%s</option>', $wert1,
                                                    $wert2);
                                            }
                            ...
                            <?php if (isset($redeem) && $redeem == 1) { ?>
                                ...
                                <table width="400" border="0">
                                    <thead>
                                    <tr>
                                        <th colspan="2">Pr&auml;sent Empf&auml;ngerdaten
                                        </td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="firma" class="text_field" placeholder="Firma"
                                                   value="<?php if (isset($firma)) {
                                                       echo $firma;
                                                   } ?>"/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="anrede" class="select_field">
                                                <option value="Herr" <? if (isset($anrede) && $anrede == 'Herr') {
                                                    echo 'selected';
                                                } ?>>Herr
                                                </option>
                                                <option value="Frau" <? if (isset($anrede) && $anrede == 'Frau') {
                                                    echo 'selected';
                                                } ?>>Frau
                                                </option>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="vorname" class="text_field" placeholder="Vorname"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="name" class="text_field" placeholder="Name"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="strasse" class="text_field" placeholder="Strasse"
                                                   value="<?php if (isset($strasse)) {
                                                       echo $strasse;
                                                   } ?>" required="required"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th scope="col">Nr.</th>
                                        <td><input type="text" name="hnr" class="text_field" placeholder="Hausnummer"
                                                   value="<?php if (isset($hnr)) {
                                                       echo $hnr;
                                                   } ?>" required="required"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th scope="col">PLZ</th>
                                        <td><input type="text" name="plz" class="text_field" placeholder="PLZ"
                                                   value="<?php if (isset($plz)) {
                                                       echo $plz;
                                                   } ?>" required="required"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th scope="col">Ort</th>
                                        <td><input type="text" name="ort" class="text_field" placeholder="Ort"
                                                   value="<?php if (isset($ort)) {
                                                       echo $ort;
                                                   } ?>" required="required"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="land" class="text_field" placeholder="Land"
                                                   value="<?php if (isset($land)) {
                                                       echo $land;
                                                   } else {
                                                       echo 'Deutschland';
                                                   } ?>" required="required"/></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="email" name="email" class="text_field"
                                                   placeholder="mail@example.com" value="<?php if (isset($email)) {
                                                echo $email;
                                            } ?>" required="required"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="telefon" class="text_field" placeholder="Telefon"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($versanddatum)) {
                                                $myCalendar->setDate(date("d", $versanddatum), date("m", $versanddatum),
                                                    date("Y", $versanddatum));
                                            }
                                ...
                                <table width="400" border="0">
                                    <thead>
                                    <tr>
                                        <th colspan="2">Einl&ouml;sungsort
                                        </td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select name="einloesungsort" class="select_field">
                                                <option value="2" <? if (isset($einloesungsort) && $einloesungsort == 2) {
                                                    echo 'selected';
                                                } ?>>Internet
                                                </option>
                                                <option value="3" <? if (isset($einloesungsort) && $einloesungsort == 3) {
                                                    echo 'selected';
                                                } ?>>Post
                                                </option>
                                                <option value="4" <? if (isset($einloesungsort) && $einloesungsort == 4) {
                                                    echo 'selected';
                                                } ?>>Gesch&auml;ft
                                                </option>
                                            </select>
                            ...
                            <table width="400" border="0">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <input type="button" name="back" class="submit_btn" value="Abbrechen"
                                               onclick="setLocation('coupons.php')"/>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
                    ...
                    if (isset($edit) && $updated === false) {
                        print('<div class="contentBoxRed">Keinen Gutschein mit dieser Nummer gefunden.</div>');
                    }
                }
