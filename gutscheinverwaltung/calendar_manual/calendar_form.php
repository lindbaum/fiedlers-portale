...
function setValue(){
	...
	var date_selected = padString(f.selected_day.value, 2, "0") + "." + padString(f.selected_month.value, 2, "0") + "." + padString(f.selected_year.value, 4, "0");
...
function submitNow(dvalue, mvalue, yvalue){
	...
	if($auto_submit){
		...
		if($form_name){
			...
			echo("var date_selected = dvalue + \",\" + + mvalue + \",\" + yvalue;\n");
