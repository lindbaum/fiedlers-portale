    ...
    <div id="main">
        ...
        <div id="content">
            ...
            if(isset($delete)) {
                ...
                $sql = "UPDATE gsv_gutschein SET gsv_praesent_prae_id = 1 WHERE gsv_praesent_prae_id = ?";
                ...
                // Client lšschen
                $sql = "DELETE FROM gsv_praesent WHERE prae_id = ?";
            ...
            print('<div class="contentBox"><a href="gifts.php">Zur&uuml;ck</a></div>');
