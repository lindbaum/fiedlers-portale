...
//    $laender['de']['SI'] = "Slowenien";
    ...
    $csv_output = '';
    $csv_output .= 'TNT-Kundennummer' . ";" . 'Name' . "; " . 'Strasse1' . "; " . 'Strasse2' . "; " . 'Kontakt' . "; " . 'PLZ' . ";  " . 'Stadt' . "; " . 'Land ' . ";" . 'Service' . "; " . 'Option' . ";  " . 'Referenz' . ";  " . 'Gewicht' . "; " . 'Packmittel' . "; " . 'Länge' . ";  " . 'Breite' . ";  " . 'Höhe' . "; " . 'Inhalt' . ";   " . 'Anzahl' . ";  " . 'Email' . ";" . 'Einlösedatum' . ";" . 'Versanddatum' . ";";
    $csv_output .= "\n";
    while ($kommando->fetch()) {
        ...
        $csv_output .= '70049012'.";".htmlspecialchars_decode($vorname,ENT_QUOTES).' '.htmlspecialchars_decode($nachname,ENT_QUOTES).";".$strasse.' '.$hnr.";" . ' ' . ";".htmlspecialchars_decode($firma, ENT_QUOTES).";".$plz.";".$ort.";".$landCode.";".'12B'.";". ' ' .";".$gsnummer.";".$gewicht.";".'Karton'.";".'10'.";".'10'.";".'10'.";".$praesent.";".'1'.";".$email.";".date('d.m.Y',$einloesedatum).";".date('d.m.Y', $versanddatum).";";

        $csv_output .= "\n";
    }

    $filename = "versandliste_erweitert_tnt-" . date('d-m-Y', $versanddatum);
