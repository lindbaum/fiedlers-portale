...
//    $laender['de']['SI'] = "Slowenien";
    ...
    $csv_output = '';
    $csv_output .=  'AdressCode'."; ".'Kundennummer'.";".'Name'.";  ".'Name2'."; ".'Kontakt'."; ".'Strasse'."; ".'Hausnummer'."; ".'Land '.";".'PLZ'.";  ".'Stadt'."; ".'Region'."; ".'Email'."; ".'EmailSprache'."; ".'Telefon'."; ".'Fax'."; ".'UstNr'.";".'GLN'.";".'EORI'.";".'Bemerkungen'.";".'istAbholadresse'.";".'istPrivatAdresse'.";".'DienstleisterKundennummern'.";".'Zusatz1'.";".'Zusatz2'.";".'Zusatz'.";";
    $csv_output .= "\n";
    while($kommando->fetch()) {

        $landCode  = array_search($land, $laender['de']);  // Ländernamen in 2 stelliges Länderkürzel ( DE ) umwandeln;

        $csv_output .=   $nachname."; ".$nachname."; ".$vorname.' '.$nachname."; ". htmlspecialchars_decode($firma,ENT_QUOTES)."; ".' '.";  ".$strasse."; ".$hnr."; ".$landCode."; ".$plz."; ".$ort."; ".' '."; ".$email."; ".' '."; ".$telefon.";";

        $csv_output .= "\n";
    }

    $filename = "versandliste_tnt";
