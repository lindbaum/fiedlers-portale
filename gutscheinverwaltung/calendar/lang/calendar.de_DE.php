...
define("L_PREV", "Zur&uuml;ck");
define("L_NEXT", "Vor");
define("L_REF_CAL", "Kalender aktualisieren...");
define("L_CHK_VAL", "Eingabe &uuml;berpr&uuml;fen");
define("L_SEL_LANG", "Sprache ausw&auml;hlen");
define("L_SEL_ICON", "Symbol ausw&auml;hlen");
define("L_SEL_DATE", "Datum ausw&auml;hlen");
define("L_ERR_SEL", "Ihre Auswahl ist falsch");
define("L_NOT_ALLOWED", "Dieses Datum kann man nicht ausw&auml;hlen");
define("L_DATE_BEFORE", "Bitte w&auml;hlen Sie ein Datum vor dem %s");
define("L_DATE_AFTER", "Bitte w&auml;hlen Sie ein Datum nach %s");
define("L_DATE_BETWEEN", "Bitte w&auml;hlen Sie ein Datum zwischen\\n%s und %s");
