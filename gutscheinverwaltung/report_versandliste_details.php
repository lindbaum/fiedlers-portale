    ...
    <div id="main">
        ...
        <div id="content">
            ...
            if(isset($_POST['date1']) && $_POST['date1'] != '0000-00-00') {
                ...
                $tbl_header = array('GS-Nr.', 'Pr&auml;sent', 'RG-Nr.', 'Anrede', 'Vorname', 'Name', 'Firma', 'Strasse', 'Haus-Nr.', 'PLZ', 'Ort');
                tbl_header($tbl_header, false, false);
                tbl_body_open();
                
                while($kommando->fetch()) {
                    printf('<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>', $gutscheinnummer, $praesent, $rechnungsnummer, $anrede, $vorname, $nachname, $firma, $strasse, $hnr, $plz, $ort);
                }
                ...
                <tfoot>
                    <tr>
                        <td colspan="11"><?php printf('%s Eintr&auml;ge gefunden.', $kommando->num_rows); ?></td>
                    </tr>
                </tfoot>
                ...
                printf('<div class="contentBox"><a href="report_versandliste_details_csv.php?date=%s" target="_blank"><img src="images/save_csv.png" align="middle" alt="Speichern als"></a>&nbsp;CSV-Export</div>', $datum);
