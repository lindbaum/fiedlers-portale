...
<title>Fiedler Fisch- & Meeresdelikatessen | Gutscheinverwaltung v1.2</title>
...
function get_before_update_time()
{
    return 1636498800;
}

function calc_timezone($time)
{
    return $time + 3600;
}

function is_old_date($date)
{
    $date = (int)$date;
    return $date < get_before_update_time();
}
