    ...
    <div id="main">
        ...
        <div id="content">
            ...
            if(isset($_POST['date1']) && $_POST['date1'] != '0000-00-00') {
                ...
                $dateA = strtotime($_POST['date1'] . ' UTC');
                $dateB = strtotime($_POST['date1'] . ' Europe/Berlin');
                $getBeforeUpdateTime = get_before_update_time();
                ...
                $sql = "SELECT A.empf_anrede, A.empf_vorname, A.empf_nachname, A.empf_firma, A.empf_strasse, A.empf_hausnummer,
                        ...
                        AND ((A.wunsch_versand_datum = ? AND  A.einloese_datum < $getBeforeUpdateTime) OR A.wunsch_versand_datum = $dateB)
                        ORDER BY A.einloese_datum ASC, A.gutschein_nummer ASC";

                $kommando = $db->prepare($sql);
                $kommando->bind_param('i', $dateA);
                $kommando->execute();
...
//                printf('<div class="contentBox"><a href="report_versandliste_tnt_csv.php?date=%s" target="_blank"><img src="images/save_csv.png" align="middle" alt="Speichern als TNT "></a>&nbsp;Speichern als TNT CSV-Export</div>', $datum);
                printf('<div class="contentBox"><a href="report_versandliste_tnt_extend_csv.php?date=%s&dateB=%s" target="_blank"><img src="images/save_csv.png" align="middle" alt="Speichern als TNT "></a>&nbsp;Erweiterten TNT CSV-Export speichern</div>', $dateA,$dateB);
                printf('<div class="contentBox"><a href="report_versandliste_tnt_extend_csv_mit_Telefon.php?date=%s&dateB=%s" target="_blank"><img src="images/save_csv.png" align="middle" alt="Speichern als TNT "></a>&nbsp;Erweiterten TNT CSV-Export mit Telefon speichern</div>', $dateA,$dateB);
            }
