...
if(isset($_POST['submit'])) {
    ...
    else (isset($_POST['nummer_von']) && preg_match('/^([0-9]{5,6})$/', $_POST['nummer_von'])) ? $nummer_von = $_POST['nummer_von'] : $error .= 'Bitte geben Sie eine korrekte Gutscheinnummer f&uuml;r das "von"-Feld an.<br />'; 
    if(isset($_POST['nummer_bis']) && !empty($_POST['nummer_bis'])) (preg_match('/^([0-9]{5,6})$/', $_POST['nummer_bis'])) ? $nummer_bis = $_POST['nummer_bis'] : $error .= 'Bitte geben Sie eine korrekte Gutscheinnummer f&uuml;r das "bis"-Feld an.<br />';
