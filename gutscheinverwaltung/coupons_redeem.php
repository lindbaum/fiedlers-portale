...
if(isset($_POST['submit'])) {
    $error = '';
    (isset($_POST['nummer']) && preg_match('/^([0-9]{5,6})$/', $_POST['nummer'])) ? header('Location:coupons_redeem_edit.php?edit=' . $_POST['nummer']) : $error .= '<br />Bitte geben Sie eine korrekte Gutscheinnummer an.'; 
}
